...
box.items.push({ id: uid(), name: 'Lamp', fate: 'keep', description: '', notes: '', photos: [], addedAt: new Date().toISOString() });
box.items.push({ id: uid(), name: 'Chair', fate: 'donate', description: '', notes: '', photos: [], addedAt: new Date().toISOString() });
...
var item = { id: uid(), name: 'Stapler', fate: 'unsure', description: '', notes: '', photos: [], addedAt: new Date().toISOString() };
box.items.push(item);
